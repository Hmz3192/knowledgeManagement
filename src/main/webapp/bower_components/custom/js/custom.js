angular.module('FileManagerApp').config(['fileManagerConfigProvider', function (config) {
    ...
    config.set({
        appName: '文件管理',
        listUrl: 'http://localhost:8111/listFile.mvc',
        renameUrl: "http://localhost:8111/renameFile.mvc",
        removeUrl: 'http://localhost:8111/removeFile.mvc',
        getContentUrl: 'http://localhost:8111/getContent.mvc',
        editUrl: 'http://localhost:8111/saveFile.mvc',
        downloadFileUrl: 'http://localhost:8111/previewFile.mvc',
        createFolderUrl: 'http://localhost:8111/createFolder.mvc',

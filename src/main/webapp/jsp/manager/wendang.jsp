                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-12">
                                <ol class="breadcrumb">
                                    <li><a href="#">Home</a></li>
                                    <li class="active"><span>文档</span></li>
                                </ol>
                            </div>
                        </div>
                        <div class="row">
                                            ...
                                            <table id="user" class="table table-hover" style="clear: both">
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="65%"><a href="#" id="username" data-type="text"
                                                                       ...
                                                                       class="editable editable-click">周五春游吧</a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>用户2</td>
                                                    <td><a href="#" id="firstname" data-type="text" data-pk="1"
                                                           ...
                                                           class="editable editable-click editable-empty">大风呼呼呼呼呼呼呼</a></td>
                                                </tr>
                                                <tr>
                                                    <td>用户3</td>
                                                    <td><a href="#" id="sex" data-type="select2" data-pk="1"
                                                           data-value="" data-title="Select sex"
                                                           class="editable editable-click" style="color: gray;">实习日记</a></td>
                                                </tr>
                                                <tr>
                                                    <td>用户4</td>
                                                    <td><a href="#" id="group" data-type="select" data-pk="1"
                                                           data-value="5" data-source="/groups"
                                                           data-title="Select group" class="editable editable-click">打游戏吧</a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>用户5</td>
                                                    <td><a href="#" id="status" data-type="select" data-pk="1"
                                                           ...
                                                           data-title="Select status" class="editable editable-click">谁打匈奴</a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>用户6</td>
                                                    <td>
                                                        <span class="notready">大学生毕业怎么办？</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>用户7</td>
                                                    <td><a href="#" id="dob" data-type="combodate"
                                                           ...
                                                           class="editable editable-click">凡事往前看</a></td>
                                                </tr>
                                                <tr>
                                                    <td>用户8</td>

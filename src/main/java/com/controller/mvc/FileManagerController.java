...
import com.treePojo.*;
import com.treePojo.treeUtils.FileType;
import com.treePojo.treeUtils.FtUtils;
import com.treePojo.treeUtils.MultipartFileSender;
...
public class FileManagerController {
    ...
    public FileDescList listFile(@RequestBody ReqParamList paramList) {
        ...
        Path currentPath = Paths.get(ConstantPara.UPLOAD_FOLDER + pathStr);
    ...
    public FileDescSingle renameFile(@RequestBody ReqParamList paramList) {
        ...
        Path sourcePath = Paths.get(ConstantPara.UPLOAD_FOLDER + pathStr);
        Path desPath = Paths.get(ConstantPara.UPLOAD_FOLDER + newPathStr);
    ...
    public FileDescSingle createFolder(@RequestBody ReqParamList paramList) {
        ...
        String pathStr = param.getPath();
        pathStr = pathStr.replace("\\", File.separator);
        Path sourcePath = Paths.get(ConstantPara.UPLOAD_FOLDER + File.separator + pathStr + File.separator + param.getName());
        logger.info(pathStr);
        FileDesc desc = null;
        FileDescSingle fileDescSingle = new FileDescSingle();
        try {
